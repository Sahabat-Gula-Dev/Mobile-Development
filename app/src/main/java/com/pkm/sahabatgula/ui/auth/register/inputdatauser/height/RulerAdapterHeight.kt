...
import com.pkm.sahabatgula.databinding.ItemRulerHeightBinding

class RulerAdapterHeight(private val minValue: Int, private val maxValue: Int) : RecyclerView.Adapter<RulerAdapterHeight.RulerViewHolder>() {

    inner class RulerViewHolder(val binding: ItemRulerHeightBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RulerViewHolder {
        ...
        val binding = ItemRulerHeightBinding.inflate(LayoutInflater.from(parent.context), parent, false)
